...
// TODO: replaying works but the button does not want to show up 
//       and theres a couple minor issues so ill fix it later
...
struct $modify(ReplayUI, EditorUI) {
    ...
    bool init(LevelEditorLayer* lel) {
        ...
        auto replayPos = menu->getChildByID("playtest-button")->getPosition();
        m_fields->replayBtn->setPosition(ccp(replayPos.x + 40, replayPos.y));
